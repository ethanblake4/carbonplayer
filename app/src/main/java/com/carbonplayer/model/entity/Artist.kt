...
open class Artist (
    ...
    constructor(json: JSONObject, realm: Realm) : this () {
        ...
        artistArtRefs = "artistArtRefs".let { if(json.has(it)) {
        ...
        albums = "albums".let { if(json.has(it)) {
        ...
        topTracks = "topTracks".let { if(json.has(it)) {
        ...
        relatedArtists = "related_artists".let { if(json.has(it)) {
